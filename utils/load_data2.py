...
def load_articles(obj):
    ...
    train_dict = pickle.load(open('data/news_articles/' + obj + '_train_re.pkl', 'rb'))
    test_dict = pickle.load(open('data/news_articles/' + obj + '_test_re.pkl', 'rb'))
...
def load_reframing(obj):
    ...
    restyle_dict_train1_1 = pickle.load(open('data/news_articles/' + obj+ '_train_re.pkl', 'rb'))
    restyle_dict_train1_2 = pickle.load(open('data/news_articles/' + obj+ '_train_re.pkl', 'rb'))
    restyle_dict_train2_1 = pickle.load(open('data/news_articles/' + obj+ '_train_re.pkl', 'rb'))
    restyle_dict_train2_2 = pickle.load(open('data/news_articles/' + obj+ '_train_re.pkl', 'rb'))
    ...
    x_train_res2 = np.array(restyle_dict_train2_1['news'])
    x_train_res2_2 = np.array(restyle_dict_train2_2['news'])

    y_train_fg, y_train_fg_m, y_train_fg_t = finegrain_dict1['orig_fg'], finegrain_dict1['orig_fg'], finegrain_dict1['orig_fg']
    y_train_fg2, y_train_fg_m2, y_train_fg_t2 = finegrain_dict2['orig_fg'], finegrain_dict2['orig_fg'], finegrain_dict2['orig_fg']
