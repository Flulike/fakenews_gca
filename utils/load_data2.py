...
def load_reframing(obj):
    ...
    restyle_dict_train1_1 = pickle.load(open('dataset/news_articles/' + obj+ '_train_re.pkl', 'rb'))
    restyle_dict_train1_2 = pickle.load(open('dataset/news_articles/' + obj+ '_train_re.pkl', 'rb'))
    restyle_dict_train2_1 = pickle.load(open('dataset/news_articles/' + obj+ '_train_re.pkl', 'rb'))
    restyle_dict_train2_2 = pickle.load(open('dataset/news_articles/' + obj+ '_train_re.pkl', 'rb'))
