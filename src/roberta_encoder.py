...
class RobertaEmbeddings(nn.Module):
    ...
    def forward(
        ...
        if inputs_embeds is None:
            inputs_embeds = self.word_embeddings(input_ids) #此处有问题
...
class RobertaEncoderResults(RobertaPreTrainedModel):
    """
...
class BertEncoderResults(RobertaEncoderResults):
    """BERT encoder variant that reuses the shared fusion-aware implementation."""
